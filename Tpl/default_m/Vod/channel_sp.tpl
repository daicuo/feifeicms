...
<php>$item_vod=ff_mysql_vod('cid:'.ff_list_ids($list_id).';tag_name:'.$feifeilist.';tag_list:vod_type;limit:20;cache_name:default;cache_time:default;order:vod_stars desc,vod_addtime;sort:desc');if(!$item_vod){continue;}</php>
<div class="container ff-bg">
