...
<php>$item_vod=ff_mysql_vod('cid:'.ff_list_ids($list_id).';area:'.$feifeilist.';limit:15;cache_name:default;cache_time:default;order:vod_stars desc,vod_addtime;sort:desc');if(!$item_vod){continue;}</php>
<div class="container ff-bg">
<div class="page-header">
  ...
  <span class="pull-right"><a class="btn btn-success btn-xs" href="{:ff_url('list/select',array('id'=>$list_id,'type'=>'','area'=>urlencode($feifeilist),'year'=>'','star'=>'','state'=>'','order'=>'addtime','p'=>1),true)}">更多</a></span>
  </h2>
</div>
