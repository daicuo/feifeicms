...
<div class="container ff-bg hidden-xs hidden-sm">
	<div class="page-header">
		...
		<a class="pull-right text-green" href="{:ff_url('list/select',array('id'=>$list_id,'area'=>'','gender'=>'','profession'=>'','letter'=>'','order'=>'hits','p'=>1),true)}">更多<span class="glyphicon glyphicon-chevron-right"></span></a>
		</h2>
	</div>
	<ul class="list-unstyled">
		<volist name="item_star" id="feifei">
		<li class="col-xs-2 px-0 py-0 text-center text-gray">
