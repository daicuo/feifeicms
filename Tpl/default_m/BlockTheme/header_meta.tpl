...
<link rel="stylesheet" href="{$public_path}jquery.flickity/2.1.1/flickity.min.css">
<link rel="stylesheet" href="{$root}Tpl/base/bootstrap3.css?{%feifeicms_version}">
...
<script type="text/javascript" src="{$public_path}jquery.flickity/2.1.1/flickity.pkgd.min.js"></script>
