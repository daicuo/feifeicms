...
<include file="./Tpl/base/seo/list_top" />
</head>
<body class="list-top">
...
<div class="table-responsive">
  <table class="table table-striped table-bordered table-responsive">  
    <tbody>
    	<volist name=":ff_mysql_vod('field:list_id,list_dir,list_name,vod_id,vod_actor,vod_type,vod_area,vod_ename,vod_name,vod_jumpurl,vod_url,vod_pic,vod_content,vod_hits_month;limit:100;cache_name:default;cache_time:default;order:vod_hits_month;sort:desc')" id="feifei">
      ...
      <tr>
        ...
        <td class="col-xs-1 text-center">
				...
				<td class="col-xs-1 text-center">
					<small>{$feifei.vod_hits_month|number_format}</small>
				</td>
      </tr>
      </volist>
    </tbody>
