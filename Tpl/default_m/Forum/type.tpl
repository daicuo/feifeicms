...
<div class="page-header">
  <h2 class="text-nowrap">
		...
		<div class="btn-group pull-right">
			...
			<li <eq name="select_sid" value="1">class="active"</eq>"><a href="{:ff_url('list/select',array('id'=>$list_id,'sid'=>1,'p'=>1),true)}">视频评论</a></li>
			<li <eq name="select_sid" value="2">class="active"</eq>"><a href="{:ff_url('list/select',array('id'=>$list_id,'sid'=>2,'p'=>1),true)}">文章评论</a></li>
			<li <eq name="select_sid" value="3">class="active"</eq>"><a href="{:ff_url('list/select',array('id'=>$list_id,'sid'=>3,'p'=>1),true)}">专题评论</a></li>
			<li <eq name="select_sid" value="5">class="active"</eq>"><a href="{:ff_url('list/select',array('id'=>$list_id,'sid'=>5,'p'=>1),true)}">留言评论</a></li>
			<li <eq name="select_sid" value="8">class="active"</eq>"><a href="{:ff_url('list/select',array('id'=>$list_id,'sid'=>8,'p'=>1),true)}">明星评论</a></li>
			<li <eq name="select_sid" value="9">class="active"</eq>"><a href="{:ff_url('list/select',array('id'=>$list_id,'sid'=>9,'p'=>1),true)}">角色评论</a></li>			
			</ul>
		</div>
  </h2>
</div>
