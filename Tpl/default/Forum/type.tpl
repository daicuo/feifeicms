<php>$item_list = ff_mysql_forum('cid_not:0;pid:0;limit:30;sid:'.$select_sid.';page_is:true;page_id:forum;page_p:'.$select_page.';cache_name:default;cache_time:default;order:forum_addtime;sort:desc');
$page_array = $_GET['ff_page_forum'];
$page_info = ff_url_page('list/read', array('id'=>$list_id,'sid'=>$select_sid,'p'=>'FFLINK'), true, 'forum', 4);
</php><!DOCTYPE html>
<html lang="zh-cn">
<head>
<include file="./Tpl/base/bootstrap3/inc_header" />
<include file="./Tpl/base/seo/forum_type" />
</head>
<body class="forum-type">
...
<ul class="list-unstyled ff-select">
	...
	<li class="col-xs-6 col-md-1 <eq name="select_sid" value="1">active</eq>"><a class="btn btn-default btn-block" href="{:ff_url('list/select',array('id'=>$list_id,'sid'=>1,'p'=>1),true)}">视频评论</a></li>
	<li class="col-xs-6 col-md-1 <eq name="select_sid" value="2">active</eq>"><a class="btn btn-default btn-block" href="{:ff_url('list/select',array('id'=>$list_id,'sid'=>2,'p'=>1),true)}">文章评论</a></li>
	<li class="col-xs-6 col-md-1 <eq name="select_sid" value="3">active</eq>"><a class="btn btn-default btn-block" href="{:ff_url('list/select',array('id'=>$list_id,'sid'=>3,'p'=>1),true)}">专题评论</a></li>
	<li class="col-xs-6 col-md-1 <eq name="select_sid" value="5">active</eq>"><a class="btn btn-default btn-block" href="{:ff_url('list/select',array('id'=>$list_id,'sid'=>5,'p'=>1),true)}">留言评论</a></li>
	<li class="col-xs-6 col-md-1 <eq name="select_sid" value="8">active</eq>"><a class="btn btn-default btn-block" href="{:ff_url('list/select',array('id'=>$list_id,'sid'=>8,'p'=>1),true)}">明星评论</a></li>
	<li class="col-xs-6 col-md-1 <eq name="select_sid" value="9">active</eq>"><a class="btn btn-default btn-block" href="{:ff_url('list/select',array('id'=>$list_id,'sid'=>9,'p'=>1),true)}">角色评论</a></li>
</ul>	
</div>
...
<div class="page-header">
  <h2 class="text-ellipsis">
		...
		第<span class="text-green">{$select_page}</span>页
		<label class="pull-right hidden-xs hidden-sm">
...
<gt name="page_array.totalpages" value="1">
  ...
  <ul class="pager visible-xs visible-sm">
    <gt name="list_page" value="1">
      <li><a id="ff-prev" href="{:ff_url('list/select', array('id'=>$list_id,'sid'=>$select_sid,'p'=>($list_page-1)), true)}">上一页</a></li>
    </gt>
    <lt name="list_page" value="$page_array['totalpages']">
      <li><a id="ff-next" href="{:ff_url('list/select', array('id'=>$list_id,'sid'=>$select_sid,'p'=>($list_page+1)), true)}">下一页</a></li>
    </lt>
  </ul>
  </div>
</gt>
