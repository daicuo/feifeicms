...
if($forum_cid){
	$info = reset(ff_mysql_star('ids:'.$forum_cid.';limit:1;cache_name:default;cache_time:default;order:person_id;sort:desc'));
}</php><!DOCTYPE html>
<html lang="zh-cn">
<head>
<include file="./Tpl/base/bootstrap3/inc_header" />
<include file="./Tpl/base/seo/forum_detail_star" />
</head>
<body class="forum-detail forum-detail-star">
...
<div class="page-header">
  <h2 class="text-ellipsis">
    <span class="glyphicon glyphicon-comment text-green"></span>
		<a href="{:ff_url('star/forum', array('id'=>$forum_cid), true)}">《{$info.person_name|msubstr=0,36,true}》的话题</a>
...
<div class="page-header">
  <h2>
		<span class="glyphicon glyphicon-comment text-green"></span> 发表您对此评论的看法
	</h2>
</div>
<!--发表评论后刷新网页 -->
