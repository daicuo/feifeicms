...
$jump = array('id'=>$special_id,'p'=>'FFLINK');
$item_list = ff_mysql_forum($params);
$page_info = ff_url_page('special/forum', $jump, true, $params['page_id'], 4);
...
<body class="special-detail-forum">
...
<gt name="page_total" value="1">
  ...
  <ul class="pager visible-xs visible-sm">
    <gt name="params.page_p" value="1">
      <li><a id="ff-prev" href="{:ff_url('special/forum', array('id'=>$special_id,'p'=>($params['page_p']-1)), true)}">上一页</a></li>
    </gt>
    <lt name="params.page_p" value="$page_total">
      <li><a id="ff-next" href="{:ff_url('special/forum', array('id'=>$special_id,'p'=>($params['page_p']+1)), true)}">下一页</a></li>
    </lt>
  </ul>
  </div>
</gt>
