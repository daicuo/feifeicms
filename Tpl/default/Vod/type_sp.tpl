<php>$item_vod = ff_mysql_vod('cid:'.$list_id.';limit:60;tag_name:'.$select_type.';tag_list:vod_type;area:'.$select_area.';year:'.implode(',',str_split($select_year,4)).';actor:'.$select_star.';state:'.$select_state.';page_is:true;page_id:type;page_p:'.$select_page.';cache_name:default;cache_time:default;order:vod_'.$select_order.';sort:desc');
